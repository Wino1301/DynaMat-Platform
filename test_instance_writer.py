...
def test_specimen_instance():
    ...
    specimen_form_data = {
        ...
        # GUI properties (should be filtered out)
        "https://dynamat.utep.edu/ontology#hasDisplayName": "Original Diameter (mm)",
        "https://dynamat.utep.edu/ontology#hasFormGroup": "GeometryDimensions",
    }
